...
La consulta virtual, diseñada para ajustarse a tus horarios y comodidad, ofrece una solución flexible. Pudiendo ayudarte en temas como matrimonios (nacionales o extranjeros), sucesiones, testamentos y herencias, unión de hecho, legalización de documentos, poderes, traducciones y apostillas, comaternidades, sociedades, entre otros.

Al elegir nuestra consulta legal virtual, puedes esperar un proceso simple y conveniente y con una asesoría de una especialista en derechos LGBTQI+.

Comprendo la importancia de la privacidad y la confidencialidad en asuntos legales sensibles. Puedes estar seguro de que cualquier información compartida durante la consulta virtual se trata con el más alto nivel de privacidad y seguridad.
...
En CELIG, valoramos la confianza que colocas en nosotros al compartir tus preocupaciones y desafíos legales. Así que nuestra consulta presencial te ofrece la oportunidad de reunirte cara a cara. Ya sea que estés considerando evacuar dudas sobre cuestiones de derecho de familia, o estés explorando opciones para un matrimonio igualitario en Costa Rica, estamos aquí para escuchar tus necesidades y darte un asesoramiento completo.
...
En casos de herencia, es crucial que el cliente comprenda los procedimientos legales. Estaré disponible para ti y tu familia. Trabajamos junto a ti para asegurarnos de que los deseos de tu ser querido se cumplan según lo establecido en lo declarado en su correspondiente testamento.

En el marco de un servicio de sucesiones, primero es necesario identificar y valorar los activos y pasivos del fallecido. Poseo amplia experiencia en este proceso, lo que nos permite gestionarlo de manera eficiente. Así mismo garantizamos llevar a cabo todos los trámites legales de acuerdo con las leyes vigentes.
...
Centramos el enfoque en ti y en preservar los deseos de tu ser querido. En situaciones donde no exista un testamento, brindamos asistencia en el proceso de distribución siguiendo las leyes de sucesión correspondientes. Nuestra meta es aliviar tus preocupaciones legales durante este período que puede llegar a ser de suma complejidad.
...
Mi enfoque abarca diversas áreas, incluido el apoyo al matrimonio igualitario. Trabajamos incansablemente para asegurar que todas las parejas tengan acceso a este derecho fundamental. Nuestros abogados están aquí para guiar y empoderar a la comunidad LGBTIQ+.
...
Los matrimonios igualitarios son un símbolo de avance en la sociedad costarricense. Me enorgullezco de ser parte de este progreso. Luchamos por la igualdad en cada matrimonio y luchamos por un futuro inclusivo para la comunidad LGBTIQ+.
...
**Te acompaño personalmente en el día más importante de tu vida.** Como Ana Isabel Sibaja, he tenido el privilegio de oficiar más de 250 matrimonios igualitarios desde 2020. Cada ceremonia es especial para mí porque entiendo, como madre de hijos LGBTIQ+, el valor profundo de este momento. No solo celebro tu amor, sino que lo hago desde la comprensión genuina de lo que significa para nuestra comunidad. Con más de 34 años de experiencia legal y el corazón de una madre que lucha por la igualdad, me aseguro de que tu día especial sea perfecto en cada detalle legal y emocional. Celebra tu amor conmigo y avancemos juntos hacia un futuro igualitario y lleno de amor.`,
  },

  {
    title: "Servicios Notariales",
    slug: "notariales",
    contenido: `En CELIG, ofrecemos una gama completa de servicios notariales en Costa Rica para atender tus necesidades legales de manera eficiente y precisa. Estoy comprometida en brindarte asesoría legal y apoyo en una variedad de trámites, entre los cuales:

▶ **Matrimonios:** Servicios que abarcan desde la preparación, la celebración e inscripción ante el registro civil, asegurando que todos los detalles legales se manejen correctamente.

▶ **Divorcios:** Te ayudo a elaborar y registrar los documentos necesarios para llevar a cabo una disolución legal y ordenada.

▶ **Segregaciones y traspasos de propiedades:** Estoy capacitada para ayudarte en la preparación y ejecución de documentos para transferir la propiedad de manera legal y transparente.

▶ **Declaraciones juradas:** Estos documentos oficiales pueden ser necesarios en diversas situaciones legales, y estaré disponible para ayudarte a preparar y certificar estas declaraciones.

▶ **Trámites de hipotecas:** Nuestros servicios abarcan un amplio espectro de acciones destinadas a brindarte seguridad y tranquilidad. Esto incluye la meticulosa preparación y minucioso registro de documentos de hipoteca, respaldando cada paso con un profundo conocimiento legal.
